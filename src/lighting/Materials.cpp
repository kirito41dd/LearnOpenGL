...
int main(int argc, char **argv)
{
    ...
    string vs,fs;
    vs = shaderPath + "materials.vs"; fs = shaderPath + "materials.fs";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("material.specular",  1.0f, 0.5f, 0.31f); // specular lighting doesn't have full effect on this object's material
